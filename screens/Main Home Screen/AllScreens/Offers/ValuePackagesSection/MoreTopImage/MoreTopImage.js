...
const MoreTopImage = () => {
  const CONTENT = {
    ...
    tableData: [['₹50,000','₹25,000','₹75,000']],
  };
  return (
  ...
  <NativeText style={styles.discount}>Get <NativeText style={styles.highlight}>50%</NativeText> benefits</NativeText>
  ...
  <Table borderStyle={{ borderWidth: 1 ,borderColor:'#2f2f2f' }}>
      ...
      <NativeText style={styles.validity}>Validity <NativeText style={styles.highlight2}>9 months</NativeText> from date of purchase</NativeText>
  </View>
  </ImageBackground>
  )
}

export default MoreTopImage

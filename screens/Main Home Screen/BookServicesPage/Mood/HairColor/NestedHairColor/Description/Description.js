...
const Description = () => {
  ...
  return (<View style={{backgroundColor: '#fff'}}>
    <View style={styles.descriptionContainer}>
      <Image style={styles.image} source={require('../../../../../../../assets/Images/Book_Now_Images/logo/lorealInoa.png')}/>
      <View style={styles.descriptionTextContainer}>
        <Text style={styles.descriptionTitle}>
          Inoa by L'Oréal Professionnel
        </Text>
        <Text style={styles.descriptionText}>
        Inoa Products Are 100% Vegan And Cruelty-Free. They Are Also Free From Toxins Such As Sulphates, Parabens, Petrolatum, Formaldehyde And Artificial Colour. As Sulphates, Parabens, Petrolatum, Formaldehyde.
        </Text>
      </View>
    </View>
